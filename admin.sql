...
INSERT INTO `sys_user_menu` VALUES (1,'系统管理',0,'系统管理',1,1,''),(2,'日志',0,'日志',1,1,''),(3,'上传',0,'上传',2,1,''),(4,'个人设置',0,'个人设置',1,1,''),(5,'权限管理',1,'sys-user-menu/index',1,1,''),(6,'查看',5,'sys-user-menu/view',1,1,''),(7,'获取单个权限信息',5,'sys-user-menu/one',1,1,''),(8,'添加',5,'sys-user-menu/create',1,1,''),(9,'更新',5,'sys-user-menu/update',1,1,''),(10,'删除',5,'sys-user-menu/delete',1,1,''),(11,'缓存管理',1,'cache/index',1,NULL,''),(12,'清除缓存',11,'cache/clean-cache',1,NULL,''),(13,'管理员组',1,'sys-user-group/index',1,NULL,''),(14,'查看',13,'sys-user-group/view',1,NULL,''),(15,'添加',13,'sys-user-group/create',1,NULL,''),(16,'更新',13,'sys-user-group/update',1,NULL,''),(17,'删除',13,'sys-user-group/delete',1,NULL,''),(18,'权限查看',13,'sys-user-group/authority',1,NULL,''),(19,'权限修改',13,'sys-user-group/authority-modify',1,NULL,''),(20,'管理员',1,'sys-user/index',1,NULL,''),(21,'查看',20,'sys-user/view',1,NULL,''),(22,'添加',20,'sys-user/create',1,NULL,''),(23,'更新',20,'sys-user/update',1,NULL,''),(24,'删除',20,'sys-user/delete',1,NULL,''),(25,'管理日志',2,'log-admin/index',1,NULL,''),(26,'查看',25,'log-admin/view',1,NULL,''),(27,'系统日志',2,'log-sys/index',1,NULL,''),(28,'查看',27,'log-sys/view',1,NULL,''),(29,'上传文件',3,'upload/index',1,NULL,''),(30,'编译器上传',3,'upload/ueditor-img',1,NULL,''),(31,'修改资料',4,'sys-user-config/modify-info',1,NULL,''),(32,'数据管理',0,'数据管理',1,NULL,''),(33,'数据库',32,'fetch-task/index',1,NULL,''),(34,'查看',33,'fetch-task/view',1,NULL,''),(35,'添加',33,'fetch-task/create',1,NULL,''),(36,'更新',33,'fetch-task/update',1,NULL,''),(37,'删除',33,'fetch-task/delete',1,NULL,''),(38,'数据表',32,'fetch-task-item/index',1,NULL,''),(39,'查看',38,'fetch-task-item/view',1,NULL,''),(40,'添加',38,'fetch-task-item/create',1,NULL,''),(41,'更新',38,'fetch-task-item/update',1,NULL,''),(42,'删除',38,'fetch-task-item/delete',1,NULL,''),(43,'数据管理模型',32,'fetch-auto-model/index',2,NULL,''),(44,'查看',43,'fetch-auto-model/view',1,NULL,''),(45,'添加',43,'fetch-auto-model/create',1,NULL,''),(46,'更新',43,'fetch-auto-model/update',1,NULL,''),(47,'删除',43,'fetch-auto-model/delete',1,NULL,''),(48,'安装库',33,'fetch-task/install-base',1,NULL,''),(49,'搜索',43,'fetch-auto-model/search-result',1,NULL,''),(50,'配置表',33,'fetch-task/config-table',1,NULL,'');
...
-- Dump completed on 2017-02-10 17:45:17
